...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.9\linewidth]{Abbildungen/Weltenbau/Magie/Magiekontrolle-Arten-Uebersicht}
	\caption[Übersicht der Arten der Magiekontrolle]{\textbf{Alle bekannten Arten der Kontrolle über Magie in der Übersicht.} \\ 
	Verwandte Arten sind durch ihre Kategorisierung und ihre Verbindung über durchgängig schwarzen Pfeile gekennzeichnet. Relationen zwischen verschiedenen Arten (dabei insbesondere bezogen auf die Hominini) sind durch gestrichelte schwarze Pfeile dargestellt.}
