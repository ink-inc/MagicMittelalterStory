...
\subsection{Bindungsstärke}\label{sec:bindungsmagie} \ref{tab:magie-verbreitung}
Mittels dieser Fähigkeit lassen sich Atombindungen stärken oder schwächen, wodurch ein Verhärtungs- oder Erweichungseffekt hervorgerufen wird. Als erweiterte und veränderte Form der \nameref{sec:druckmagie} wird dabei gleichzeitig ein starker negativer (Verhärtung) oder positiver (Erweichung) Druck von außen appliziert, wodurch sich das veränderte Material nicht plötzlich um den gleichen Faktor verkleinert oder vergrößert.
