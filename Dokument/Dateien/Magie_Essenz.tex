...
\\ \\
Viele Lebewesen haben im Laufe der Evolution Mechanismen entwickelt, um die ihnen innewohnende Magie in ihrem Sinne auf einem intuitiven Level umzuwandeln bzw einzusetzen.
...
\\ \\
Es gibt ein paar Prokaryoten, die sich die Magie als tatsächliche Energiequelle erschlossen haben und sie direkt zur Herstellung von ATP (Adenosintriphosphat = "`Energie der Zelle"') nutzen können.
